# Graph Report - AutoGram  (2026-07-27)

## Corpus Check
- 392 files · ~502,674 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2554 nodes · 5351 edges · 297 communities (145 shown, 152 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 133 edges (avg confidence: 0.79)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `bc78f823`
...
Cohesion: 0.08
Nodes (80): cache_root(), cancel_flags(), cancel_progressive(), clear_thumb_mem_cache(), convert_avcc_to_annexb(), data_url_jpeg_header(), download_media_thumb(), download_thumb_bytes() (+72 more)
...
Cohesion: 0.10
Nodes (53): _media_row_marker(), auth_status_blocking(), CachedLiveClient, cancel_qr_login(), clear_cached_user_profile(), delete_grammers_session_files(), DialogFilterRow, disconnect_cached_session() (+45 more)
...
Cohesion: 0.08
Nodes (47): ext_of(), extract_office_zip(), extract_rtf_plain(), guess_mime(), is_text_ext(), LocalDocPreview, looks_binary(), pretty_json() (+39 more)
...
Cohesion: 0.21
Nodes (28): list_topics_blocking(), warm_preview_head_blocking(), connect_client(), download_file_blocking(), forward_messages_blocking(), is_pool_or_transport_error(), list_dialog_filters_blocking(), list_dialogs_blocking() (+20 more)
...
Cohesion: 0.09
Nodes (56): resolve_sessions_dir(), sessions_dir_nonempty(), calculate_cache_size(), cancel_execution(), clear_disk_cache(), create_job(), CreateJobRequest, delete_job() (+48 more)
...
Cohesion: 0.15
Nodes (30): ensure_grammers_session(), fresh_login_does_not_persist_session_before_auth_key(), import_session_blocking(), probe_sessions_blocking(), PathBuf, export_grammers_to_telethon_file(), grammers_session_path(), GrammersSessionFile (+22 more)
...
Cohesion: 0.20
Nodes (11): is_fatal_auth_error(), _code_ok(), Into, Option, Self, String, TgError, TgErrorCode (+3 more)
...
Cohesion: 0.31
Nodes (9): clear_peer_cache_for_all(), peer_cache(), peer_to_ref(), resolve_peer(), Peer, RwLock, user_to_ref(), PeerRef (+1 more)
...
Cohesion: 0.50
Nodes (4): CACHE_LIMIT_LABELS, CACHE_LIMIT_STEPS, DebugSection, Settings()
...
## Knowledge Gaps
- **668 isolated node(s):** `fs`, `command`, `results`, `pages`, `candidates` (+663 more)
...
- **Why does `TelegramIdentity` connect `TgError` to `frontend/src-tauri/src/lib.rs`, `grammers_media.rs`, `telegram_ops.rs`, `grammers_ops.rs`, `drive_rpc.rs`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `OpResult` connect `telegram_ops.rs` to `frontend/src-tauri/src/lib.rs`, `tg_error.rs`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `TgError` connect `tg_error.rs` to `grammers_media.rs`, `telegram_ops.rs`, `grammers_ops.rs`, `job_queue.rs`, `list_zip_sparse`, `session_rate.rs`, `TgError`, `jobs_db.rs`, `telethon_session_import.rs`, `drive_rpc.rs`, `stats_db.rs`?**
