                        ...
                        for it in p_items {
                            ...
                            set.spawn(async move {
                                ...
                                tg_log::info(
                                    BACKEND,
                                    "thumb_item_fallback",
                                    format!("op=thumb_item_fallback batch_id={batch_id} item_request_id={item_req_id} requested_peer_id={peer_str} requested_message_id={mid} classification={}", classification.as_str()),
                                );
