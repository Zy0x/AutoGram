...
import { AccountLoginWizard } from './AccountLoginWizard';
  ...
  if (isModal) {
    return isWizardOpen ? (
      <AccountLoginWizard
        ...
        stringSessionInput={stringSessionInput}
        setStringSessionInput={setStringSessionInput}
        handleImportStringSession={handleImportStringSession}
        code={code}
        setCode={setCode}
        ...
        handleSignIn2FA={handleSignIn2FA}
