...
export function buildLightTokensFallback(darkTokens: ColorPaletteTokens): ColorPaletteTokens {
  const primary = darkTokens['--primary'] || darkTokens['--color-accent'] || '#0284c7';
  const accent = darkTokens['--accent'] || darkTokens['--color-secondary'] || '#d97706';
  ...
  return buildTokens({
    ...
    primary,
    accent,
    glowPrimary: `color-mix(in srgb, ${primary} 25%, transparent)`,
    colorSecondaryCard: `color-mix(in srgb, ${accent} 10%, transparent)`,
    colorSecondaryBorder: `color-mix(in srgb, ${accent} 35%, transparent)`,
    textPrimary: '#0f172a',
    ...
    tdBg: '#f8fafc',
    tdSurface: '#f1f5f9',
    tdTopbarBg: 'rgba(241, 245, 249, 0.92)',
    tdCardBg: '#ffffff',
    tdCardHover: '#f8fafc',
    tdPrimary: primary,
    tdBorder: '#cbd5e1',
...
export const COLOR_PALETTES: Record<ColorPaletteId, ColorPaletteDef> = {
  ...
  default: {
    ...
    tokensLight: buildTokens({
      ...
      accent: '#d97706',
      glowPrimary: 'rgba(2, 132, 199, 0.25)',
      colorSecondaryCard: 'rgba(217, 119, 6, 0.10)',
      colorSecondaryBorder: 'rgba(217, 119, 6, 0.35)',
      textPrimary: '#0f172a',
      textSecondary: '#475569',
      badgeBg: 'rgba(2, 132, 199, 0.12)',
  ...
  solar_flare: {
    ...
    tokensLight: buildTokens({
      ...
      primary: '#c2410c',
      accent: '#d97706',
      glowPrimary: 'rgba(194, 65, 12, 0.25)',
      colorSecondaryCard: 'rgba(217, 119, 6, 0.10)',
      colorSecondaryBorder: 'rgba(217, 119, 6, 0.35)',
      textPrimary: '#431407',
      ...
      tdBg: '#fff7ed',
      tdSurface: '#ffedd5',
      tdTopbarBg: 'rgba(255, 237, 213, 0.92)',
      tdCardBg: '#ffffff',
      tdCardHover: '#fffaf5',
      tdPrimary: '#c2410c',
      tdBorder: '#fed7aa',
  ...
  warm_clay: {
    ...
    tokensLight: buildTokens({
      ...
      primary: '#9a3412',
      accent: '#b45309',
      glowPrimary: 'rgba(154, 52, 18, 0.25)',
      colorSecondaryCard: 'rgba(180, 83, 9, 0.10)',
      colorSecondaryBorder: 'rgba(180, 83, 9, 0.35)',
      textPrimary: '#2c231e',
      ...
      statusDot: '#9a3412',
      borderColor: '#e2d6cd',
      inputFocusRing: '#9a3412',
      inputBg: '#ffffff',
      tdBg: '#faf7f5',
      tdSurface: '#f3ece7',
      tdTopbarBg: 'rgba(243, 236, 231, 0.92)',
      tdCardBg: '#ffffff',
      tdCardHover: '#fdfbfa',
      tdPrimary: '#9a3412',
      tdBorder: '#e2d6cd',
  ...
  warm_mocha: {
    ...
    tokensLight: buildTokens({
      ...
      primary: '#854d0e',
      accent: '#b45309',
      glowPrimary: 'rgba(133, 77, 14, 0.25)',
      colorSecondaryCard: 'rgba(180, 83, 9, 0.10)',
      colorSecondaryBorder: 'rgba(180, 83, 9, 0.35)',
      textPrimary: '#261c14',
      textSecondary: '#695241',
      badgeBg: 'rgba(133, 77, 14, 0.12)',
      badgeText: '#854d0e',
      statusDot: '#854d0e',
      borderColor: '#e4dacd',
      inputFocusRing: '#854d0e',
      inputBg: '#ffffff',
      tdBg: '#fbf9f6',
      tdSurface: '#f3eee7',
      tdTopbarBg: 'rgba(243, 238, 231, 0.92)',
      tdCardBg: '#ffffff',
      tdCardHover: '#fefdfb',
      tdPrimary: '#854d0e',
      tdBorder: '#e4dacd',
  ...
  lavender_dusk: {
    ...
    tokensLight: buildTokens({
      ...
      bgPanel: '#ffffff',
      surfaceLight: '#f3e8ff',
      surfaceElevated: '#fdfaff',
      colorAccent: '#7c3aed',
      colorSecondary: '#db2777',
      primary: '#7c3aed',
      accent: '#db2777',
      glowPrimary: 'rgba(124, 58, 237, 0.25)',
      colorSecondaryCard: 'rgba(219, 39, 119, 0.10)',
      colorSecondaryBorder: 'rgba(219, 39, 119, 0.35)',
      textPrimary: '#2e1065',
      ...
      tdBg: '#faf5ff',
      tdSurface: '#f3e8ff',
      tdTopbarBg: 'rgba(243, 232, 255, 0.92)',
      tdCardBg: '#ffffff',
      tdCardHover: '#fdfaff',
      tdPrimary: '#7c3aed',
      tdBorder: '#e9d5ff',
  ...
  botanical_sage: {
    ...
    tokensLight: buildTokens({
      ...
      accent: '#0d9488',
      glowPrimary: 'rgba(4, 120, 87, 0.25)',
      colorSecondaryCard: 'rgba(13, 148, 136, 0.10)',
      colorSecondaryBorder: 'rgba(13, 148, 136, 0.35)',
      textPrimary: '#06281e',
      textSecondary: '#2d5c4d',
      badgeBg: 'rgba(4, 120, 87, 0.12)',
      badgeText: '#047857',
      statusDot: '#047857',
      borderColor: '#c4ded4',
      ...
      tdBg: '#f2f8f5',
      tdSurface: '#e3f0ea',
      tdTopbarBg: 'rgba(227, 240, 234, 0.92)',
      tdCardBg: '#ffffff',
      tdCardHover: '#f8fbf9',
      tdPrimary: '#047857',
      tdBorder: '#c4ded4',
  ...
  vintage_amber: {
    ...
    tokensLight: buildTokens({
      ...
      accent: '#ca8a04',
      glowPrimary: 'rgba(180, 83, 9, 0.25)',
      colorSecondaryCard: 'rgba(202, 138, 4, 0.10)',
      colorSecondaryBorder: 'rgba(202, 138, 4, 0.35)',
      textPrimary: '#2c1e0b',
      textSecondary: '#6b4e23',
      badgeBg: 'rgba(180, 83, 9, 0.12)',
      badgeText: '#b45309',
      statusDot: '#b45309',
      borderColor: '#e8dece',
      ...
      tdBg: '#fdfbf7',
      tdSurface: '#f6f0e4',
      tdTopbarBg: 'rgba(246, 240, 228, 0.92)',
      tdCardBg: '#ffffff',
      tdCardHover: '#fffefc',
      tdPrimary: '#b45309',
      tdBorder: '#e8dece',
...
export function applyColorPalette(paletteId?: ColorPaletteId): void {
  ...
  const activeTokens = resolved === 'light'
    ? (def.tokensLight || buildLightTokensFallback(def.tokens))
    : def.tokens;
