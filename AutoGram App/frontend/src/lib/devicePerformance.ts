...
function buildProfile(tier: PerfTier): DrivePerfProfile {
  ...
  return {
    ...
    statsDelayMs: 350,
    fullMediaStats: true,
    thumbBatch: turbo ? 80 : 64,
    thumbFlushMs: turbo ? 0 : 1,
    thumbQueueMax: turbo ? 480 : 300,
    thumbConcurrent: turbo ? 12 : 8,
    thumbResumeMs: turbo ? 0 : 20,
    thumbPrefetchRows: turbo ? 8 : 5,
    prefetchNextPage: true,
    avatarBatch: turbo ? 14 : 10,
    avatarQueueMax: turbo ? 56 : 40,
    avatarBootPauseMs: turbo ? 40 : 100,
    folderScanDelayMs: 0,
    thumbSoftFailMs: 1_500,
    fastNet: turbo,
