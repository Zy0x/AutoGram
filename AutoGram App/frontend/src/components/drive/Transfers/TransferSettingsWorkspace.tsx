  ...
  return (
    <div className={`td-xfer-single-workspace ${embedded ? 'is-embedded' : 'is-standalone'}`}>
      ...
      <main className="td-xfer-panel-viewport">
        {/* TOP MINI PRESET BAR (VISIBLE ON ALL CONFIGURATION PAGES EXCEPT ENCODING) */}
        {activeTab !== 'menu' && activeTab !== 'encoding' && (
          <div
            style={{
              display: 'flex',
              alignItems: 'center',
        ...
        {activeTab === 'encoding' && (
          <div className="td-xfer-focused-panel" id="section-encoding-mode">
            ...
            {/* MASTER PARENT SECTION 4: PRESET PRAKTIS TRANSCODING VIDEO */}
            <div className="td-encoding-master-card" style={{ marginTop: '24px' }}>
              <div className="td-encoding-master-header">
                <div className="td-encoding-master-head-left">
                  <div className="td-master-icon-badge">
                  ...
                  <div>
                    <div className="td-master-title-flex">
                      <h3>4. Preset Praktis Transcoding Video</h3>
                    </div>
                    <p className="td-master-desc">
                      Pilih preset konfigurasi praktis siap pakai untuk menyesuaikan kualitas, resolusi, dan kecepatan pengodean video pengunggahan secara otomatis.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="td-settings-card is-nested-card">
                <div className="td-card-head">
                  ...
                  <div>
                    <h4>Preset Siap Pakai (Quick Configuration Preset)</h4>
                    <p>Aktifkan preset dengan 1-klik untuk menerapkan parameter encoder yang teruji.</p>
                  </div>
                </div>
                    ...
                    return (
                      <button
                        ...
                        style={{
                          ...
                          background: isSelected
                            ? 'linear-gradient(135deg, rgba(56, 189, 248, 0.15) 0%, rgba(3, 105, 161, 0.25) 100%)'
                      ...
                      >
                        <div style={{ fontWeight: 700, fontSize: '0.9rem', display: 'flex', alignItems: 'center', gap: '6px' }}>
                          <Zap size={14} style={{ color: isSelected ? '#38bdf8' : '#94a3b8' }} />
