...
export function buildSearchRegistry(t: TFunction): SearchableSettingItem[] {
  return [
    // DRIVE POWER TOOLS
    {
      ...
      label: String(t('drive.tools_tab_dups')),
      description: String(t('drive.tools_tab_dups_desc')),
    ...
    },
    {
      ...
      label: String(t('drive.tools_tab_rename')),
      description: String(t('drive.tools_tab_rename_desc')),
    ...
    },
    {
      ...
      label: String(t('drive.tools_tab_space')),
      description: String(t('drive.tools_tab_space_desc')),
    ...
    },
    {
      ...
      label: String(t('drive.tools_tab_filter')),
      description: String(t('drive.tools_tab_filter_desc')),
    ...
    },
    {
      ...
      label: String(t('drive.upload_quality_header')),
      description: String(t('drive.upload_quality_hint')),
    ...
    },
    {
      ...
      label: String(t('drive.encoder_mode_title')),
      description: String(t('drive.encoder_mode_desc')),
    ...
    },
    {
      ...
      label: String(t('drive.upload_parallelism_header')),
      description: String(t('drive.upload_parallelism_hint')),
    ...
    },
    {
      ...
      label: String(t('drive.default_caption_title')),
      description: String(t('drive.default_caption_hint')),
    ...
    },
    {
      ...
      label: String(t('drive.album_orchestration_title')),
      description: String(t('drive.album_orchestration_desc')),
    ...
    },
    {
      ...
      label: String(t('drive.tools_tab_duplicate')),
      description: String(t('drive.tools_tab_duplicate_desc')),
    ...
    },
    {
      ...
      label: String(t('drive.download_parallel_header')),
      description: String(t('drive.download_parallelism_hint')),
    ...
    },
    {
      ...
      label: String(t('drive.tools_tab_oversize')),
      description: String(t('drive.tools_tab_oversize_desc')),
    ...
    },
    {
      ...
      label: String(t('drive.hide_restricted_media_title')),
      description: String(t('drive.hide_restricted_media_desc')),
      keywords: [
        'restricted',
        'channel',
        'saluran',
