            ...
            >
              <button
                ...
                style={{
                  ...
                  color: activeInspectorTab === 'ai' ? 'var(--accent-primary, #38bdf8)' : 'var(--text-secondary, #e2e8f0)',
                  border: 'none',
                  cursor: 'pointer',
                  textAlign: 'left',
                  width: '100%',
              ...
              <button
                ...
                style={{
                  ...
                  color: activeInspectorTab === 'metadata' ? 'var(--accent-primary, #38bdf8)' : 'var(--text-secondary, #e2e8f0)',
                  border: 'none',
                  cursor: 'pointer',
                  textAlign: 'left',
                  width: '100%',
              ...
              <button
                ...
                style={{
                  ...
                  color: activeInspectorTab === 'hex' ? 'var(--accent-primary, #38bdf8)' : 'var(--text-secondary, #e2e8f0)',
                  border: 'none',
                  cursor: 'pointer',
                  textAlign: 'left',
                  width: '100%',
              ...
              {isJsonFile && (
                <button
                  ...
                  style={{
                    ...
                    color: activeInspectorTab === 'tree' ? 'var(--accent-primary, #38bdf8)' : 'var(--text-secondary, #e2e8f0)',
                    border: 'none',
                    cursor: 'pointer',
                    textAlign: 'left',
                    width: '100%',
              ...
              {isFontFile && (
                <button
                  ...
                  style={{
                    ...
                    color: activeInspectorTab === 'font' ? 'var(--accent-primary, #38bdf8)' : 'var(--text-secondary, #e2e8f0)',
                    border: 'none',
                    cursor: 'pointer',
                    textAlign: 'left',
                    width: '100%',
              ...
              {isDbFile && (
                <button
                  ...
                  style={{
                    ...
                    color: activeInspectorTab === 'db' ? 'var(--accent-primary, #38bdf8)' : 'var(--text-secondary, #e2e8f0)',
                    border: 'none',
                    cursor: 'pointer',
                    textAlign: 'left',
                    width: '100%',
              ...
              {isText && (
                <button
                  ...
                  style={{
                    ...
                    color: activeInspectorTab === 'code' ? 'var(--accent-primary, #38bdf8)' : 'var(--text-secondary, #e2e8f0)',
                    border: 'none',
                    cursor: 'pointer',
                    textAlign: 'left',
                    width: '100%',
